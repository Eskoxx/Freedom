...
#ns-body { width: 100%; color: #c4b5fd; text-align: center; }
#ns-status { width: 100%; color: #c4b5fd; text-align: center; height: 1; }
.op-buttons { width: 100%; height: auto; align: center middle; margin: 1 0 0 0; }
.op-btn, .ns-btn { width: auto; height: 1; min-width: 1; padding: 0 1; margin: 0 1; border: none; background: transparent; color: #6b6577; display: none; }
