...
Freedom also runs on **Android** — the Freedom app has a dedicated Android build with a native APK. See the [Freedom Android](https://github.com/Eskoxx/Freedom-Android) repo, or grab the ready-to-install **arm64 APK** from the [releases](https://github.com/Eskoxx/Freedom-Android/releases) page.
